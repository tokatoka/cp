...
signed main(){
   ...
   * c33 = a3 + b3
   *
   * test if (b2-b1) and (b3 - b2) and (b1 - b3) are always valid in expressions of c
  */
  int ctr = 0;
  if(((c[0][1]-c[0][0]) == (c[1][1]-c[1][0])) && ((c[2][1] - c[2][0]) == (c[1][1] - c[1][0]))){
    ctr++;
  }
  if(((c[0][2]-c[0][1]) == (c[1][2]-c[1][1])) && ((c[2][2] - c[2][1]) == (c[1][2] - c[1][1]))){
    ctr++;
  }
  if(((c[0][0]-c[0][2]) == (c[1][0]-c[1][2])) && ((c[2][0] - c[2][2]) == (c[1][0] - c[1][2]))){
    ctr++;
  }
