...
signed main(){
  ...
  ll ret = 0;
  //MAR
  ret += ctr[0]*ctr[1]*ctr[2];
  //MAC
  ret += ctr[0]*ctr[1]*ctr[3];
  //MAH
  ret += ctr[0]*ctr[1]*ctr[4];
  //MRC
  ret += ctr[0]*ctr[2]*ctr[3];
  //MRH
  ret += ctr[0]*ctr[2]*ctr[4];
  //MCH
  ret += ctr[0]*ctr[3]*ctr[4];
  //ARC
  ret += ctr[1]*ctr[2]*ctr[3];
  //ARH
  ret += ctr[1]*ctr[2]*ctr[4];
  //ACH
  ret += ctr[1]*ctr[3]*ctr[4];
  //RCH
  ret += ctr[2]*ctr[3]*ctr[4];
